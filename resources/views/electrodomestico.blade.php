                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="btn-group">
                                        ...
                                        <button type="button" data-toggle="modal" data-target="#editelectrodomestico" class="btn btn-primary editarElectrodomestico" id="editarElectrodomestico">Actualizar</button>
                                    </div>
                                </td>
                            </tr>
                            @endforeach
