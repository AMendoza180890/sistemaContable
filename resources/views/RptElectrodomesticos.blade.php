...
@section('title', 'Reporte Equipo y Mobiliario')

@section('content_header')
    <h1>Reporte de Equipo y Mobiliario de Oficina y Docentes</h1>
@stop
...
@section('content')
    ...
    <div class="card">
         <div class="card-body">
            ...
            <table class="table table-bordered table-hover table-striped TB" id="ReporteElectrodomesticos">
                <thead>
                    <tr>
                        <th>CODIGO</th>
                        <th>CODIGO</th>
                ...
                <tbody>
                    @foreach ($listaElectrodomesticos as $listado)
                        <tr>
                            <td>{{ $listado->CODIGOAF}}</td>
...
@section('js')
    ...
    <script>
        $(document).ready(function() {
            $('#ReporteElectrodomesticos').DataTable({
                paginate: false,
                dom: 'Bfrtip',
                buttons: [{
                        extend: 'copy',
