...
@section('title', 'Reporte Vehiculo')

@section('content_header')
    <h1>Reporte de Vehiculo</h1>
@stop
...
@section('content')
    ...
    <div class="card">
         <div class="card-body">
            ...
            <table class="table table-bordered table-hover table-striped TB" id="ReporteVehiculo">
                <thead>
                    <tr>
                        <th>CODIGO</th>
                        <th>CATEGORIA</th>
                ...
                <tbody>
                    @foreach ($listaVehiculo as $listado)
                        <tr>
                            <td>{{ $listado->CODIGO }}</th>
                            <td>{{ $listado->descripcionActivoFjo }}</th>
                            <td>{{ $listado->catvehiculoModelo }}</th>
                            <td>{{ $listado->catvehiculoFechaCompra }}</th>
                            <td>{{ 'C$ ' . $listado->catVehiculoCosto }}</th>
