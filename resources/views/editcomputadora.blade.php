                        ...
                        <div class="box-body">
                            <div class="form-row">
                                <div class="form-group col-md-6">
                                    ...
                                    <input type="text" class="form-control" name="inputModeloE" id="inputModeloE" placeholder="ej. inspiron, Thinkpad, etc." required>
                                    <input type="hidden" name="compIdE" id="compIdE">
                                </div>
                                <div class="form-group col-md-6">
                                    <label for="inputSerieE">Numero de Serie</label>
                                    <input type="text" class="form-control" name="inputSerieE" id="inputSerieE" placeholder="ej. MYL12345678." required>
                                </div>
                            </div>
                            <div class="form-group">
                                <label for="inputMarcaE">Marca</label>
                                <input type="text" class="form-control" name="inputMarcaE" id="inputMarcaE" placeholder="ej. DELL, Lenovo, HP, etc." required>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-row">
                                <div class="form-group col-md-6">
                                    ...
                                    <input type="text" class="form-control" name="InputTipoMemoriaE" id="InputTipoMemoriaE" required>
                                </div>
                                <div class="form-group col-md-6">
                                    <label for="cantTotalRamE">Cantidad total RAM</label>
                                    <input type="text" class="form-control" name="cantTotalRamE" id="cantTotalRamE" required>
                                </div>
                            </div>
                            <div class="form-group">
                                    <label for="compTipoSOE">Tipo SO</label>
                                    <select class="form-control" id="compTipoSOE" name="compTipoSOE" required>
