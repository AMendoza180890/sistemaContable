...
@section('title', 'Reporte Terreno')

@section('content_header')
    <h1>Reporte de Terreno</h1>
@stop
...
@section('content')
    ...
    <div class="card">
         <div class="card-body">
            ...
            <table class="table table-bordered table-hover table-striped TB" id="ReporteTerreno">
                <thead>
                    <tr>
                        <th>CODIGO</th>
                        <th>CATEGORIA</th>
                ...
                <tbody>
                    @foreach ($listaTerreno as $listado)
                        <tr>
                            <td>{{ $listado->CODIGO }}</th>
                            <td>{{ $listado->descripcionActivoFjo }}</th>
                            <td>{{ $listado->catTerrenoPropietario }}</th>
                            <td>{{ $listado->catterrenoFechaCompra }}</th>
                            <td>{{ 'C$ ' . $listado->catTerrenoCosto }}</th>
