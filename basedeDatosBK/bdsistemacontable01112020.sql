...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 02-11-2020 a las 02:13:36
...
(SELECT
    ...
    `bdsistemacontable`.`catelectrodomesticos`.`updated_at` AS `FECHA_BAJA`,
    `bdsistemacontable`.`cattipocuentaactivofijo`.`vidaUtilActivoFijo` AS `VIDA_UTIL`,
    `calculoMes`(
        CURDATE(), `bdsistemacontable`.`catelectrodomesticos`.`CatElectFechaIngreso`) AS `MESES`,
        `depreciacionMensual`(
        ...
        `depreciacionAcumulativa`(
            `calculoMes`(
                CURDATE(), `bdsistemacontable`.`catelectrodomesticos`.`CatElectFechaIngreso`),
                `bdsistemacontable`.`cattipocuentaactivofijo`.`vidaUtilActivoFijo`,
                `depreciacionMensual`(
                    `bdsistemacontable`.`cattipocuentaactivofijo`.`vidaUtilActivoFijo`,
                    `bdsistemacontable`.`catelectrodomesticos`.`CatElectCosto`
            ...
            WHERE
                (
                    `bdsistemacontable`.`catelectrodomesticos`.`idActivofijo` = `bdsistemacontable`.`cattipocuentaactivofijo`.`idActivofijo` AND `bdsistemacontable`.`catelectrodomesticos`.`CatElectEstado` <> 1
                )
                UNION ALL
        SELECT
            `bdsistemacontable`.`cattipocuentaactivofijo`.`descripcionActivoFjo` AS `CATEGORIA`,
            `bdsistemacontable`.`catequipocomputo`.`catEquipoMarca` AS `DETALLE_ACTIVO`,
            `bdsistemacontable`.`catequipocomputo`.`catEquipoFechaCompra` AS `FECHA_RECIBIDA`,
            `bdsistemacontable`.`catequipocomputo`.`catEquipoCostoEquipo` AS `COSTO`,
            `bdsistemacontable`.`catequipocomputo`.`updated_at` AS `FECHA_BAJA`,
            `bdsistemacontable`.`cattipocuentaactivofijo`.`vidaUtilActivoFijo` AS `VIDA_UTIL`,
            `calculoMes`(
                CURDATE(), `bdsistemacontable`.`catequipocomputo`.`catEquipoFechaCompra`) AS `MESES`,
                `depreciacionMensual`(
                    `bdsistemacontable`.`cattipocuentaactivofijo`.`vidaUtilActivoFijo`,
                ...
                `depreciacionAcumulativa`(
                    `calculoMes`(
                        CURDATE(), `bdsistemacontable`.`catequipocomputo`.`catEquipoFechaCompra`),
                        `bdsistemacontable`.`cattipocuentaactivofijo`.`vidaUtilActivoFijo`,
                        `depreciacionMensual`(
                            `bdsistemacontable`.`cattipocuentaactivofijo`.`vidaUtilActivoFijo`,
                            `bdsistemacontable`.`catequipocomputo`.`catEquipoCostoEquipo`
                    ...
                    WHERE
                        (
                            `bdsistemacontable`.`catequipocomputo`.`idActivofijo` = `bdsistemacontable`.`cattipocuentaactivofijo`.`idActivofijo` AND `bdsistemacontable`.`catequipocomputo`.`CatEquipoEstado` <> 1
                        )
                        UNION ALL
                SELECT
                    `bdsistemacontable`.`cattipocuentaactivofijo`.`descripcionActivoFjo` AS `CATEGORIA`,
                    `bdsistemacontable`.`catimpresoras`.`catImpresorasMarca` AS `DETALLE_ACTIVO`,
                    `bdsistemacontable`.`catimpresoras`.`catImpresoraFechaIngreso` AS `FECHA_RECIBIDA`,
                    `bdsistemacontable`.`catimpresoras`.`catImpresoraCosto` AS `COSTO`,
                    `bdsistemacontable`.`catimpresoras`.`updated_at` AS `FECHA_BAJA`,
                    `bdsistemacontable`.`cattipocuentaactivofijo`.`vidaUtilActivoFijo` AS `VIDA_UTIL`,
                    `calculoMes`(
                        CURDATE(), `bdsistemacontable`.`catimpresoras`.`catImpresoraFechaIngreso`) AS `MESES`,
                        `depreciacionMensual`(
                            `bdsistemacontable`.`cattipocuentaactivofijo`.`vidaUtilActivoFijo`,
                        ...
                        `depreciacionAcumulativa`(
                            `calculoMes`(
                                CURDATE(), `bdsistemacontable`.`catimpresoras`.`catImpresoraFechaIngreso`),
                                `bdsistemacontable`.`cattipocuentaactivofijo`.`vidaUtilActivoFijo`,
                                `depreciacionMensual`(
                                    `bdsistemacontable`.`cattipocuentaactivofijo`.`vidaUtilActivoFijo`,
                                    `bdsistemacontable`.`catimpresoras`.`catImpresoraCosto`
                            ...
                            WHERE
                                (
                                    `bdsistemacontable`.`catimpresoras`.`idActivofijo` = `bdsistemacontable`.`cattipocuentaactivofijo`.`idActivofijo` AND `bdsistemacontable`.`catimpresoras`.`CatImpresoraEstado` <> 1
                                )
                                UNION ALL
                        SELECT
                            `bdsistemacontable`.`cattipocuentaactivofijo`.`descripcionActivoFjo` AS `CATEGORIA`,
                            `bdsistemacontable`.`catvehiculo`.`catVehiculoModelo` AS `DETALLE_ACTIVO`,
                            `bdsistemacontable`.`catvehiculo`.`catVehiculoFechaCompra` AS `FECHA_RECIBIDA`,
                            `bdsistemacontable`.`catvehiculo`.`catVehiculoCosto` AS `COSTO`,
                            `bdsistemacontable`.`catvehiculo`.`updated_at` AS `FECHA_BAJA`,
                            `bdsistemacontable`.`cattipocuentaactivofijo`.`vidaUtilActivoFijo` AS `VIDA_UTIL`,
                            `calculoMes`(
                                CURDATE(), `bdsistemacontable`.`catvehiculo`.`catVehiculoFechaCompra`) AS `MESES`,
                                `depreciacionMensual`(
                                    `bdsistemacontable`.`cattipocuentaactivofijo`.`vidaUtilActivoFijo`,
                                ...
                                `depreciacionAcumulativa`(
                                    `calculoMes`(
                                        CURDATE(), `bdsistemacontable`.`catvehiculo`.`catVehiculoFechaCompra`),
                                        `bdsistemacontable`.`cattipocuentaactivofijo`.`vidaUtilActivoFijo`,
                                        `depreciacionMensual`(
                                            `bdsistemacontable`.`cattipocuentaactivofijo`.`vidaUtilActivoFijo`,
                                            `bdsistemacontable`.`catvehiculo`.`catVehiculoCosto`
                                    ...
                                    WHERE
                                        (
                                            `bdsistemacontable`.`catvehiculo`.`idActivofijo` = `bdsistemacontable`.`cattipocuentaactivofijo`.`idActivofijo` AND `bdsistemacontable`.`catvehiculo`.`catVehiculoEstado` <> 1
                                        )
                                        UNION ALL
                                SELECT
                                    `bdsistemacontable`.`cattipocuentaactivofijo`.`descripcionActivoFjo` AS `CATEGORIA`,
                                    `bdsistemacontable`.`catterreno`.`catTerrenoPropietario` AS `DETALLE_ACTIVO`,
                                    `bdsistemacontable`.`catterreno`.`catTerrenoFechaCompra` AS `FECHA_RECIBIDA`,
                                    `bdsistemacontable`.`catterreno`.`catterrenoCosto` AS `COSTO`,
                                    `bdsistemacontable`.`catterreno`.`updated_at` AS `FECHA_BAJA`,
                                    `bdsistemacontable`.`cattipocuentaactivofijo`.`vidaUtilActivoFijo` AS `VIDA_UTIL`,
                                    `calculoMes`(
                                        CURDATE(), `bdsistemacontable`.`catterreno`.`catTerrenoFechaCompra`) AS `MESES`,
                                        `depreciacionMensual`(
                                            `bdsistemacontable`.`cattipocuentaactivofijo`.`vidaUtilActivoFijo`,
                                        ...
                                        `depreciacionAcumulativa`(
                                            `calculoMes`(
                                                CURDATE(), `bdsistemacontable`.`catterreno`.`catTerrenoFechaCompra`),
                                                `bdsistemacontable`.`cattipocuentaactivofijo`.`vidaUtilActivoFijo`,
                                                `depreciacionMensual`(
                                                    `bdsistemacontable`.`cattipocuentaactivofijo`.`vidaUtilActivoFijo`,
                                                    `bdsistemacontable`.`catterreno`.`catterrenoCosto`
                                            ...
                                            WHERE
                                                (
                                                    `bdsistemacontable`.`catterreno`.`idActivofijo` = `bdsistemacontable`.`cattipocuentaactivofijo`.`idActivofijo` AND `bdsistemacontable`.`catterreno`.`CatTerrenoEstado` <> 1
                                                )
 ) AS `QUERYBAJA`
  WHERE
...
(1, '20EV002JUS', '001002003004005', 'LENOVO', '250Gb, SSD', 'DDR4', '16Gb', 'windows10', '2020-10-06', 4500, 1, 3, '2020-10-25', NULL),
(2, '20EV002JUS', '001002003004005', 'DELL', '250Gb, SSD', 'DDR4', '16Gb', 'windows10', '2020-10-08', 250.5, 1, 3, '2020-11-01', NULL),
(4, 'inspiron', 'MY1235678', 'HP', '250Gb', 'DDR4', '8Gb', 'windows10', '2020-06-10', 230, 2, 3, '2020-11-09', '2020-09-06');
...
(1, 'Canon', 'MF4770N', '3500BN001', 'NEGRO, MULTIFUNCIONAL, CON ACCESO A RED LAN CABLE E INALAMBRICO', '2019-10-16', 350, 2, 1, '2020-10-31', NULL),
(2, 'Epson', 'MYL12345678', '128', 'Color negro, conectado por red inalambrica', '2020-06-09', 250, 1, 3, '2020-10-31', '2020-09-06');
...
--
-- Estructura Stand-in para la vista `rptdetalleactivo_estadobajas`
-- (Véase abajo para la vista actual)
--
...
--
-- Estructura para la vista `rptdetalleactivo_estadobajas`
--
